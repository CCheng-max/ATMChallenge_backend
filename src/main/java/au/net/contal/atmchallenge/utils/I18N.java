...
public class I18N {
    ...
    public static final String INITIAL_BANKNOTES_ILLEGAL = "We're sorry, but the ATM simulator cannot be initialized because the request does not include the initial banknote values and counts. Please provide this information and try again.";
